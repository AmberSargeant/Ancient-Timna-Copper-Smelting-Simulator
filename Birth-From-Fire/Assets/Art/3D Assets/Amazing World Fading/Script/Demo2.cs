...
namespace AmazingWorldFading
{
	public class Demo2 : MonoBehaviour
	{
		...
		public bool m_InvertSphereDissolve = false;
		...
		void Update()
		{
			...
			{
				m_ObjsSphereDissolve[i].material.SetVector("_Pos", m_MainCharacter.transform.position);
				m_ObjsSphereDissolve[i].material.SetFloat("_Radius", m_VisDist);
				m_ObjsSphereDissolve[i].material.SetFloat("_Invert", m_InvertSphereDissolve ? 1f : 0f);
