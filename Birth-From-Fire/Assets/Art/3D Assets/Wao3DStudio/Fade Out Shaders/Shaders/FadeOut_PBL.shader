...
Shader "Wao3DStudio/FX/FadeOut_PBL" {
    Properties {
        ...
        _FadeOutEmission ("Fade Out Emission", Float ) = 1
        _LineThikness ("Line Thikness", Range(0, 1)) = 0.4
...
////// Specular:
                ...
                float3 specularColor = Spec.r;
                float specularMonochrome;
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0, _Diffuse));
                float3 Diff = (_DiffuseColor.rgb*_Diffuse_var.rgb*_SelfIlumination);
                float3 diffuseColor = Diff; // Need this for specular when using metallic
